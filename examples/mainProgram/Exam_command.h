...
// poppybot_setup();    คือคำสั่งสำหรับการเริ่มต้นการใช้งานของบอร์ด วางอยู่ฟังก์ชั้น Setup เป็นคำสั่งแรกสุด
...
// printText(0,Y,"Hellow"),2,ST77XX_WHITE);  คำสั่งแสดงผล Hellow ไปยังหน้าจอที่ตำแหน่ง X = 0 , Y = 10
